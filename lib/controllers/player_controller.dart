...
class PlayerController extends GetxController {
  ...
  late Stream<bool> currentNotificationStatus;
  ...
  static final PlayerController _singleton = PlayerController._internal();
  ...
  Future<void> getNotificationStatus() async {
    notificationEnabled = permissionCtrl.storage.read('notification') ?? true;
  }
  ...
  Future<void> initializeAudiosToPlay(int audioType, int index,
    ...
    if (audioType == 1) {
      ...
      List<int?> filtered =
          hiveCtrl.getPlaylistsBox().get(name)!.playlistSongsId;
